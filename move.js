$(document).ready(function(){
    ...
    $("#nxtbtn").click(function(){
        if($count == 1){ 
           shrink(); $("#slider").delay(1000).animate({left:"-100%"},1000);
            zoom();
            $count=2;
        }
        else if($count == 2){ 
           shrink();  $("#slider").delay(1000).animate({left:"-200%"},1000);
            zoom();
            $count=3;
        }
    });
    $("#prvbtn").click(function(){
        if($count == 3){ 
           ...
           shrink();  $("#slider").delay(1000).animate({left:"0%"}, 1000);
            zoom();
            $count=1;
        }
    });
    ...
    setTimeout(function(){
        ...
        setTimeout(function(){
        $("#main").css({'-webkit-clip-path':"polygon(0% 0%, 0% 100%, 100% 100%,100% 0%, 10% 0%)"});
